...
if [ "$PLATFORM" = "arm64" ]; then
  ...
  echo USE_SYSTEM_FPM=true npx electron-builder build --linux deb --arm64 \
    ...
    --config.deb.packageName="stai-blockchain" \
...
GUI_DEB_NAME=stai-blockchain_${STAI_INSTALLER_VERSION}_${PLATFORM}.deb
mv "dist/${PRODUCT_NAME}-${STAI_INSTALLER_VERSION}.deb" "../../../build_scripts/dist/${GUI_DEB_NAME}"
