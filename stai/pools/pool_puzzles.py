...
from stai.consensus.block_rewards import calculate_pool_reward
from stai.consensus.coinbase import pool_parent_id
from stai.pools.pool_wallet_info import LEAVING_POOL, SELF_POOLING, PoolState
...
from stai.wallet.puzzles.singleton_top_layer import puzzle_for_singleton
...
POOL_WAITING_ROOM_MOD = load_clvm_maybe_recompile(
    "pool_waitingroom_innerpuz.clsp", package_or_requirement="stai.pools.puzzles"
)
POOL_MEMBER_MOD = load_clvm_maybe_recompile("pool_member_innerpuz.clsp", package_or_requirement="stai.pools.puzzles")
