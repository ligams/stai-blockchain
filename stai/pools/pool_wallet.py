...
from stai.clvm.singleton import SINGLETON_LAUNCHER
from stai.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
...
from stai.pools.pool_wallet_info import (
    FARMING_TO_POOL,
    LEAVING_POOL,
    SELF_POOLING,
    PoolSingletonState,
...
from stai.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from stai.wallet.derive_keys import find_owner_sk
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `stai singleton` that is
