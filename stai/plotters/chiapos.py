"""
NOTE: This contains duplicate code from `stai.cmds.plots`.
After `stai plots create` becomes obsolete, consider removing it from there.
"""
...
from stai.plotting.util import Params, add_plot_directory, validate_plot_size
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Stai Proof of Space", "version": chiapos_version, "installed": True}


def plot_stai(args: Namespace, root_path: Path) -> None:
    try:
