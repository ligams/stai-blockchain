...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ stai passphrase set # all the cool kids are doing it!"

MASTER_PASSPHRASE_SERVICE_NAME = "Stai Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Stai Passphrase"
...
class KeyringWrapper:
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        from stai.util.keychain import supports_os_passphrase_storage
