...
from stai.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'stai show -c' has been renamed to 'stai peer full_node -c' ")
    if add_connection != "":
        print("'stai show -a' has been renamed to 'stai peer full_node -a' ")
    if remove_connection != "":
        print("'stai show -r' has been renamed to 'stai peer full_node -r' ")
    if wallet_rpc_port is not None:
        print("'stai show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
