...
from stai.util.collection import find_duplicates
from stai.util.db_synchronous import db_synchronous_on
from stai.util.db_wrapper import DBWrapper2, execute_fetchone
from stai.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in Stai wallet databases.
    The core stai client currently uses sqlite to store the wallet databases, one database per key.
\b
