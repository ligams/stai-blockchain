...
def create_fee_option() -> Callable[[FC], FC]:
    return click.option(
        "-m",
        "--fee",
        help="Set the fees for the transaction, in STAI",
        type=str,
        default=None,
        show_default=True,
        required=False,
...
def create_data_store(
    ...
    from stai.cmds.data_funcs import create_data_store_cmd
...
def get_value(
    ...
    from stai.cmds.data_funcs import get_value_cmd
...
def update_data_store(
    ...
    from stai.cmds.data_funcs import update_data_store_cmd
...
def get_keys(
    ...
    from stai.cmds.data_funcs import get_keys_cmd
...
def get_keys_values(
    ...
    from stai.cmds.data_funcs import get_keys_values_cmd
...
def get_root(
    ...
    from stai.cmds.data_funcs import get_root_cmd
...
def subscribe(
    ...
    from stai.cmds.data_funcs import subscribe_cmd
...
def remove_subscription(
    ...
    from stai.cmds.data_funcs import remove_subscriptions_cmd
...
def unsubscribe(
    ...
    from stai.cmds.data_funcs import unsubscribe_cmd
...
def get_kv_diff(
    ...
    from stai.cmds.data_funcs import get_kv_diff_cmd
...
def get_root_history(
    ...
    from stai.cmds.data_funcs import get_root_history_cmd
...
def add_missing_files(
    ...
    from stai.cmds.data_funcs import add_missing_files_cmd
...
def add_mirror(
    ...
    from stai.cmds.data_funcs import add_mirror_cmd
...
def delete_mirror(
    ...
    from stai.cmds.data_funcs import delete_mirror_cmd
...
def get_mirrors(
    ...
    from stai.cmds.data_funcs import get_mirrors_cmd
...
def get_subscriptions(
    ...
    from stai.cmds.data_funcs import get_subscriptions_cmd
...
def get_owned_stores(
    ...
    from stai.cmds.data_funcs import get_owned_stores_cmd
...
def get_sync_status(
    ...
    from stai.cmds.data_funcs import get_sync_status_cmd
...
def check_plugins(
    ...
    from stai.cmds.data_funcs import check_plugins_cmd
...
def clear_pending_roots(
    ...
    from stai.cmds.data_funcs import clear_pending_roots
...
def wallet_log_in(
    ...
    from stai.cmds.data_funcs import wallet_log_in_cmd
