...
from stai.cmds.passphrase_funcs import get_current_passphrase
...
from stai.util.service_groups import services_for_groups
...
async def async_start(root_path: Path, config: Dict[str, Any], group: tuple[str, ...], restart: bool) -> None:
    ...
    if daemon is None:
        print("Failed to create the stai daemon")
        return None
