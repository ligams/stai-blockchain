...
from stai.daemon.client import acquire_connection_to_daemon
from stai.util.errors import KeychainMaxUnlockAttempts
from stai.util.keychain import Keychain, supports_os_passphrase_storage
from stai.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE, KeyringWrapper
from stai.util.misc import prompt_yes_no
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Stai processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("STAI_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'stai passphrase set' or 'stai passphrase remove' to update or remove your passphrase")
        sys.exit(1)
