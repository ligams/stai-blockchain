...
from stai.util.network import is_localhost
...
async def summary(
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'stai start wallet' and 'stai wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'stai wallet show'")
    else:
        print("Note: log into your key using 'stai wallet show' to see rewards for each key")
