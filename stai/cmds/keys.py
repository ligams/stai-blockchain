...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Stai versions use "
...
@click.option("--prefix", "-x", help="Address prefix (stai for mainnet, tstai for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
