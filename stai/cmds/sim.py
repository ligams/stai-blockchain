...
from stai.cmds.sim_funcs import async_config_wizard, farm_blocks, print_status, revert_block_height, set_auto_farm
from stai.util.default_root import SIMULATOR_ROOT_PATH


@click.group("sim", help="Configure and make requests to a Stai Simulator Full Node")
@click.option(
    "-p",
    "--rpc-port",
    help=(
...
@sim_cmd.command("create", help="Guides you through the process of setting up a Stai Simulator")
...
@sim_cmd.command("start", help="Start service groups while automatically using the right stai_root.")
...
@sim_cmd.command("stop", help="Stop running services while automatically using the right stai_root.")
