...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(stai complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mstai complete generate > ~/.stai-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.stai-complete-bash\033[0m
    """
    ...
    subprocess.run(["stai"], check=True, env={**os.environ, "_STAI_COMPLETE": f"{shell}_source"})
