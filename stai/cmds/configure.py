    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.stai.net"
                testnet_dns_introducer = "dns-introducer-testnet10.stai.net"
                bootstrap_peers = ["testnet10-node.stai.net"]
                testnet = "testnet10"
                ...
                mainnet_port = "8444"
                mainnet_introducer = "introducer.stai.net"
                mainnet_dns_introducer = "dns-introducer.stai.net"
                bootstrap_peers = ["node.stai.net"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running stai services for changes to take effect")
