...
from stai.cmds.cmds_util import tx_config_args
...
@click.option(
    "--proposal-minimum",
    help="The minimum amount (in stai) that a proposal must use to be created",
    type=str,
...
@click.option(
    "-m",
    "--fee",
    help="Set the fees per transaction, in STAI.",
    type=str,
    default="0",
    show_default=True,
...
@click.option(
    "--fee-for-cat",
    help="Set the fees for the CAT creation transaction, in STAI.",
    type=str,
    default="0",
    show_default=True,
    callback=validate_fee,
...
@click.option(
    "--asset-id",
    help="The asset id of the funds the proposal will send. Leave blank for stai",
    type=str,
    required=False,
    default=None,
)
