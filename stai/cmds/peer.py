...
from stai.cmds.cmds_util import NODE_TYPES
from stai.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified Stai service to ip:port", type=str, default="")
@click.option(
