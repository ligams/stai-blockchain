...
class SigningMode(Enum):
    ...
    # CHIP-0002 signs the result of sha256tree(cons("Stai Signed Message", message)) using the
    ...
    # Standard BLS signatures used by Stai use the BLS message augmentation scheme
...
CHIP_0002_SIGN_MESSAGE_PREFIX = "Stai Signed Message"
