...
from stai.plotting.util import parse_plot_info
from stai.types.blockchain_format.proof_of_space import generate_plot_public_key
        ...
        try:
            ...
            if stored_cache.version == CURRENT_VERSION:
                ...
                for path, cache_entry in cache_data.entries:
                    ...
                    #       Related: - https://github.com/Stai-Network/stai-blockchain/issues/13084
                    #                - https://github.com/Stai-Network/chiapos/pull/337
                    ...
                    # See https://github.com/Stai-Network/chiapos/blob/3ee062b86315823dd775453ad320b8be892c7df3/src/prover_disk.hpp#L282-L287  # noqa: E501
