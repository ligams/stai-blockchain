...
from stai.protocols import full_node_protocol, introducer_protocol, wallet_protocol
...
class WalletNodeAPI:
    ...
    async def respond_removals(self, response: wallet_protocol.RespondRemovals, peer: WSStaiConnection):
        pass

    async def reject_removals_request(self, response: wallet_protocol.RejectRemovalsRequest, peer: WSStaiConnection):
        """
    ...
    async def new_peak_wallet(self, peak: wallet_protocol.NewPeakWallet, peer: WSStaiConnection):
        """
    ...
    @api_request(peer_required=True)
    async def respond_additions(self, response: wallet_protocol.RespondAdditions, peer: WSStaiConnection):
        pass
    ...
    @api_request(peer_required=True)
    async def transaction_ack(self, ack: wallet_protocol.TransactionAck, peer: WSStaiConnection):
        """
    ...
    @api_request(peer_required=True)
    async def respond_peers(self, request: full_node_protocol.RespondPeers, peer: WSStaiConnection):
    ...
    @api_request(peer_required=True, execute_task=True)
    async def coin_state_update(self, request: wallet_protocol.CoinStateUpdate, peer: WSStaiConnection):
