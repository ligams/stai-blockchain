...
from stai.wallet.singleton import get_inner_puzzle_from_singleton, get_singleton_id_from_puzzle
from stai.wallet.singleton_record import SingletonRecord
