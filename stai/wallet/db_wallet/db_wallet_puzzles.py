...
from stai.wallet.nft_wallet.nft_puzzles import NFT_STATE_LAYER_MOD, create_nft_layer_puzzle_with_curry_params
from stai.wallet.puzzles.load_clvm import load_clvm_maybe_recompile

# from stai.types.condition_opcodes import ConditionOpcode
# from stai.wallet.util.merkle_tree import MerkleTree, TreeType
...
GRAFTROOT_DL_OFFERS = load_clvm_maybe_recompile(
    "graftroot_dl_offers.clsp", package_or_requirement="stai.data_layer.puzzles"
)
