...
from stai.wallet.notification_store import Notification, NotificationStore
from stai.wallet.transaction_record import TransactionRecord
from stai.wallet.util.compute_memos import compute_memos_for_spend
from stai.wallet.util.notifications import construct_notification
...
class NotificationManager:
    ...
    async def send_new_notification(
        ...
        full_tx: TransactionRecord = dataclasses.replace(
            stai_tx, spend_bundle=SpendBundle.aggregate([stai_tx.spend_bundle, extra_spend_bundle])
        )
        return full_tx
