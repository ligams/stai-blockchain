...
from stai.full_node.weight_proof import _validate_sub_epoch_summaries, validate_weight_proof_inner
...
def _create_shutdown_file() -> IO[bytes]:
    return tempfile.NamedTemporaryFile(prefix="stai_wallet_weight_proof_handler_executor_shutdown_trigger")
