...
from stai.wallet.nft_wallet.nft_info import NFTCoinInfo
from stai.wallet.util.tx_config import CoinSelectionConfig
...
class WalletProtocol(Protocol[T]):
    ...
    async def coin_added(self, coin: Coin, height: uint32, peer: WSStaiConnection, coin_data: Optional[T]) -> None:
        ...
