...
address1 = "tstai15gx26ndmacfaqlq8m0yajeggzceu7cvmaz4df0hahkukes695rss6lej7h"  # Gene wallet (m/12381/8444/2/42):
address2 = "tstai1c2cguswhvmdyz9hr3q6hak2h6p9dw4rz82g4707k2xy2sarv705qcce4pn"  # Mariano address (m/12381/8444/2/0)
...
def make_puzzle(amount: int) -> int:
    ...
    for cvp in parse_sexp_to_conditions(result):
        ...
        total_stai += int_from_bytes(cvp.vars[1])
        print(
