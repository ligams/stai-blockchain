...
from stai.wallet.puzzles.clawback.metadata import ClawbackMetadata
...
from stai.wallet.puzzles.puzzle_utils import (
...
from stai.wallet.util.wallet_types import WalletIdentifier, WalletType
...
class Wallet:
    ...
    async def create_tandem_stai_tx(
        ...
        stai_coins = await self.select_coins(fee, tx_config.coin_selection_config)
        [stai_tx] = await self.generate_signed_transaction(
            uint64(0),
    ...
    # WSStaiConnection is only imported for type checking
