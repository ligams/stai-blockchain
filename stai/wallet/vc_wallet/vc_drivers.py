...
from stai.wallet.puzzles.singleton_top_layer_v1_1 import (
    SINGLETON_LAUNCHER,
...
EXTIGENT_METADATA_LAYER = load_clvm_maybe_recompile(
    ...
    package_or_requirement="stai.wallet.vc_wallet.vc_puzzles",
...
COVENANT_LAYER: Program = load_clvm_maybe_recompile(
    "covenant_layer.clsp", package_or_requirement="stai.wallet.vc_wallet.vc_puzzles", include_standard_libraries=True
)
...
VIRAL_BACKDOOR: Program = load_clvm_maybe_recompile(
    "viral_backdoor.clsp", package_or_requirement="stai.wallet.vc_wallet.vc_puzzles", include_standard_libraries=True
)
...
class VerifiedCredential(Streamable):
    ...
    def launch(
        ...
        origin_coin: An STAI coin that will be used to fund the spend. A coin of any amount > 1 can be used and the
