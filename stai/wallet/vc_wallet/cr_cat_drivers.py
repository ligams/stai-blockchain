...
from stai.wallet.puzzles.singleton_top_layer_v1_1 import SINGLETON_LAUNCHER_HASH, SINGLETON_MOD_HASH
from stai.wallet.uncurried_puzzle import UncurriedPuzzle, uncurry_puzzle
from stai.wallet.util.curry_and_treehash import curry_and_treehash
from stai.wallet.vc_wallet.vc_drivers import (
    COVENANT_LAYER_HASH,
...
CREDENTIAL_RESTRICTION: Program = load_clvm_maybe_recompile(
    ...
    package_or_requirement="stai.wallet.vc_wallet.cr_puzzles",
