...
from stai.wallet.derive_keys import master_sk_to_wallet_sk_unhardened
from stai.wallet.did_wallet import did_wallet_puzzles
from stai.wallet.did_wallet.did_info import DIDCoinData, DIDInfo
from stai.wallet.did_wallet.did_wallet_puzzles import match_did_puzzle, uncurry_innerpuz
...
class DIDWallet:
    ...
    async def coin_added(self, coin: Coin, _: uint32, peer: WSStaiConnection, parent_coin_data: Optional[DIDCoinData]):
    ...
    async def create_update_spend(
        ...
        if stai_tx is not None and stai_tx.spend_bundle is not None:
            ...
            await self.wallet_state_manager.add_pending_transaction(stai_tx)
