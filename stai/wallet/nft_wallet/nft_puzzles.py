...
NFT_STATE_LAYER_MOD = load_clvm_maybe_recompile(
    "nft_state_layer.clsp", package_or_requirement="stai.wallet.nft_wallet.puzzles"
)
...
NFT_OWNERSHIP_LAYER = load_clvm_maybe_recompile(
    "nft_ownership_layer.clsp", package_or_requirement="stai.wallet.nft_wallet.puzzles"
)
...
INTERMEDIATE_LAUNCHER_MOD = load_clvm_maybe_recompile(
    "nft_intermediate_launcher.clsp", package_or_requirement="stai.wallet.nft_wallet.puzzles"
)
