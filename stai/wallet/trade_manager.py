...
from stai.wallet.conditions import Condition, ConditionValidTimes, parse_conditions_non_consensus, parse_timelock_info
from stai.wallet.db_wallet.db_wallet_puzzles import ACS_MU_PH
...
from stai.wallet.trading.trade_store import TradeStore
...
from stai.wallet.vc_wallet.cr_cat_drivers import ProofsChecker, construct_pending_approval_state
...
class TradeManager:
    ...
    Puzzle Drivers:
      - See stai/wallet/outer_puzzles.py for a full description of how to build these
    ...
    async def coins_of_interest_farmed(
        self, coin_state: CoinState, fork_height: Optional[uint32], peer: WSStaiConnection
    ) -> None:
        """
    ...
    async def check_offer_validity(self, offer: Offer, peer: WSStaiConnection) -> bool:
