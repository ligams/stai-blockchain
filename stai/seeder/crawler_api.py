...
class CrawlerAPI:
    ...
    @api_request(peer_required=True)
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSStaiConnection) -> Optional[Message]:
    ...
    async def new_compact_vdf(
        self, request: full_node_protocol.NewCompactVDF, peer: WSStaiConnection
    ) -> Optional[Message]:
        pass
