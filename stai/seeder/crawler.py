...
from stai.protocols.full_node_protocol import RespondPeers
from stai.rpc.rpc_server import StateChangedProtocol, default_get_connections
from stai.seeder.crawl_store import CrawlStore
from stai.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def create_client(
        self, peer_info: PeerInfo, on_connect: Callable[[WSStaiConnection], Awaitable[None]]
    ) -> bool:
    ...
    async def connect_task(self, peer: PeerRecord) -> None:
        ...
        async def peer_action(peer: WSStaiConnection) -> None:
