...
class ConsensusConstants:
    ...
    MAX_FUTURE_TIME2: int  # The difference between signage point and infusion point (plus required_iters)
    ...
    # Forks of stai should change this value to provide replay attack protection
    ...
    GENESIS_PRE_FARM_OFFICIALWALLETS_PUZZLE_HASH: bytes32
    ...
    # Max coin amount uint(1 << 64). This allows coin amounts to fit in 64 bits. This is around 18M stai.
    MAX_COIN_AMOUNT: int
