...
from stai.plot_sync.exceptions import (
...
from stai.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
from stai.util.ints import int16, uint32, uint64
...
class Receiver:
    ...
    def connection(self) -> WSStaiConnection:
