...
from stai.plotting.util import PlotInfo, parse_plot_info
from stai.protocols import harvester_protocol
from stai.protocols.farmer_protocol import FarmingInfo
from stai.protocols.harvester_protocol import Plot, PlotSyncResponse
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSStaiConnection
    ) -> None:
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSStaiConnection
    ) -> None:
        """
