...
from stai.rpc.util import wrap_http_handler
from stai.server.outbound_message import NodeType
from stai.server.server import StaiServer, ssl_context_for_client, ssl_context_for_server
...
from stai.util.config import str2bool
from stai.util.ints import uint16
from stai.util.json_util import dict_to_json_str
from stai.util.network import WebServer, resolve
from stai.util.ws_message import WsRpcMessage, create_payload, create_payload_dict, format_response, pong
...
class RpcServiceProtocol(Protocol):
    ...
    def server(self) -> StaiServer:
        ...
        # a property so as to be read only which allows StaiServer to satisfy
        # Optional[StaiServer]
        ...
    ...
    def get_connections(self, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
        ...
        stai.rpc.rpc_server.default_get_connections()
        """
        ...
...
def default_get_connections(server: StaiServer, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
