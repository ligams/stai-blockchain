...
from stai.data_layer.data_layer_wallet import Mirror, SingletonRecord
from stai.pools.pool_wallet_info import PoolWalletInfo
...
from stai.wallet.conditions import Condition, ConditionValidTimes, conditions_to_json_dicts
...
from stai.wallet.vc_wallet.vc_store import VCRecord
...
class WalletRpcClient(RpcClient):
    """
    Client to Stai RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    JSON into native python objects before returning. All api calls use POST requests.
    Note that this is not the same as the peer protocol, or wallet protocol (which run Stai's
    ...
    async def nft_mint_bulk(
        ...
        stai_coins: Optional[List[Dict]] = None,
        stai_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "stai_change_target": stai_change_target,
