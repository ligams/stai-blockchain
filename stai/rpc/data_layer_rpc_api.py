...
from stai.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from stai.rpc.data_layer_rpc_util import marshal
...
from stai.util.streamable import recurse_jsonify
from stai.util.ws_message import WsRpcMessage
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "stai_data_layer"
