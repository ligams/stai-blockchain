...
from stai.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from stai.rpc.rpc_client import RpcClient
from stai.types.blockchain_format.sized_bytes import bytes32
from stai.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Stai RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
