...
from stai.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from stai.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
from stai.types.weight_proof import (
    RecentChainData,
...
def _create_shutdown_file() -> IO[bytes]:
    return tempfile.NamedTemporaryFile(prefix="stai_full_node_weight_proof_handler_executor_shutdown_trigger")
