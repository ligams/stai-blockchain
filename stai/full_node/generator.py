...
from stai.types.generator_types import BlockGenerator, CompressorArg, GeneratorBlockCacheInterface
from stai.util.ints import uint32
from stai.wallet.puzzles.load_clvm import load_clvm_maybe_recompile

DECOMPRESS_BLOCK = load_clvm_maybe_recompile("block_program_zero.clsp", package_or_requirement="stai.full_node.puzzles")
DECOMPRESS_PUZZLE = load_clvm_maybe_recompile("decompress_puzzle.clsp", package_or_requirement="stai.full_node.puzzles")
# DECOMPRESS_CSE = load_clvm_maybe_recompile(
#     "decompress_coin_spend_entry.clsp",
#     package_or_requirement="stai.full_node.puzzles",
# )
