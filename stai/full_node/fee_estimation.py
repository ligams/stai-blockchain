...
class MempoolInfo:
    ...
    Attributes:
        max_size_in_cost (uint64): This is the maximum capacity of the mempool, measured in STAI per CLVM Cost
...
class FeeMempoolInfo:
    ...
    Attributes:
        ...
        current_mempool_cost (uint64):This is the current capacity of the mempool, measured in STAI per CLVM Cost
