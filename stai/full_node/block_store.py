...
from stai.types.weight_proof import SubEpochChallengeSegment, SubEpochSegments
from stai.util.db_wrapper import DBWrapper2, execute_fetchone
from stai.util.errors import Err
from stai.util.full_block_utils import GeneratorBlockInfo, block_info_from_block, generator_from_block
...
class BlockStore:
    ...
    async def create(cls, db_wrapper: DBWrapper2, *, use_cache: bool = True) -> BlockStore:
        ...
        async with self.db_wrapper.writer_maybe_transaction() as conn:
            ...
            # in the stai/cmds/db_upgrade.py file
