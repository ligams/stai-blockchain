...
from stai.util.file_keyring import FileKeyring, keyring_path_from_root
...
class TempKeyring:
    def __init__(
        ...
        *,
        ...
        service: str = "testing-stai-1.8.0",
        populate: bool = False,
    ...
    def _patch_and_create_keychain(
        ...
        *,
        ...
        mock_supports_os_passphrase_storage_patch = patch("stai.util.keychain.supports_os_passphrase_storage")
