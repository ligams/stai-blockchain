...
from stai.cmds.init_funcs import init
...
from stai.protocols.shared_protocol import Capability, capabilities
from stai.seeder.dns_server import DNSServer, create_dns_server_service
from stai.seeder.start_crawler import create_full_node_crawler_service
from stai.server.outbound_message import NodeType
from stai.server.start_farmer import create_farmer_service
from stai.server.start_full_node import create_full_node_service
from stai.server.start_harvester import create_harvester_service
from stai.server.start_introducer import create_introducer_service
from stai.server.start_timelord import create_timelord_service
from stai.server.start_wallet import create_wallet_service
from stai.simulator.block_tools import BlockTools, test_constants
from stai.simulator.keyring import TempKeyring
from stai.simulator.ssl_certs import get_next_nodes_certs_and_keys, get_next_private_ca_cert_and_key
from stai.simulator.start_simulator import create_full_node_simulator_service
from stai.ssl.create_ssl import create_all_ssl
from stai.timelord.timelord_launcher import VDFClientProcessMgr, find_vdf_client, spawn_process
...
from stai.types.peer_info import UnresolvedPeerInfo
from stai.util.bech32m import encode_puzzle_hash
from stai.util.config import config_path_for_filename, load_config, lock_and_load_config, save_config, set_peer_info
from stai.util.db_wrapper import generate_in_memory_db_uri
from stai.util.ints import uint16
from stai.util.keychain import bytes_to_mnemonic
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["sati_spam_amount"] = sati_spam_amount
...
async def setup_farmer(
    ...
    service_config["stai_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "stai")
    service_config["pool_public_keys"] = [bytes(pk).hex() for pk in b_tools.pool_pubkeys]
    service_config["port"] = port
    service_config["rpc_port"] = uint16(0)
    config_pool["stai_target_address"] = encode_puzzle_hash(b_tools.pool_ph, "stai")
