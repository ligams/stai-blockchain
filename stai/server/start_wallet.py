...
from stai.types.aliases import WalletService
from stai.util.stai_logging import initialize_service_logging
from stai.util.config import get_unresolved_peer_infos, load_config, load_config_cli
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("STAI_INSTRUMENT_WALLET") is not None):
