...
{
    Write-Output "Stai requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Stai blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Discord in the #support chat channel:"
Write-Output "https://discord.gg/stai"
Write-Output ""
Write-Output "Try the Quick Start Guide to running stai-blockchain:"
...
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'stai init' to begin."
