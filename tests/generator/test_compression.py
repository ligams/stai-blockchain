...
from stai.full_node.mempool_check_conditions import get_puzzle_and_solution_for_coin
...
DESERIALIZE_MOD = load_clvm("chialisp_deserialisation.clsp", package_or_requirement="stai.consensus.puzzles")

DECOMPRESS_PUZZLE = load_clvm("decompress_puzzle.clsp", package_or_requirement="stai.full_node.puzzles")
DECOMPRESS_CSE = load_clvm("decompress_coin_spend_entry.clsp", package_or_requirement="stai.full_node.puzzles")

DECOMPRESS_CSE_WITH_PREFIX = load_clvm(
    "decompress_coin_spend_entry_with_prefix.clsp", package_or_requirement="stai.full_node.puzzles"
)
DECOMPRESS_BLOCK = load_clvm("block_program_zero.clsp", package_or_requirement="stai.full_node.puzzles")
