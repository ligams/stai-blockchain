...
from stai.data_layer.data_layer_util import NodeType, Side, Status
...
class StaiRoot:
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        kwargs["env"]["STAI_ROOT"] = os.fspath(self.path)
        kwargs["env"]["STAI_KEYS_ROOT"] = os.fspath(self.path)
        ...
        modified_args: List[Union[str, os_PathLike_str]] = [
            self.scripts_path.joinpath("stai"),
            "--root-path",
            self.path,
            *args,
        ]
