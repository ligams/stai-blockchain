...
from stai.server import stai_policy
...
class ServeInThread:
    ...
    def start(self) -> None:
        self.original_connection_limit = stai_policy.global_max_concurrent_connections
        # TODO: yuck yuck, messes with a single global
        stai_policy.global_max_concurrent_connections = self.connection_limit
    ...
    def _run(self) -> None:
        ...
        asyncio.set_event_loop_policy(stai_policy.StaiPolicy())
        try:
    ...
    def stop(self) -> None:
        ...
        if self.original_connection_limit is not None:
            stai_policy.global_max_concurrent_connections = self.original_connection_limit
