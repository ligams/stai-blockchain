...
from stai.server.rate_limit_numbers import compose_rate_limits, get_rate_limits_to_use
from stai.server.rate_limit_numbers import rate_limits as rl_numbers
...
class TestRateLimits:
    ...
    async def test_different_versions(self, node_with_params, node_with_params_b, self_hostname):
        ...
        full_node_server_a: StaiServer = node_a.full_node.server
        full_node_server_b: StaiServer = node_b.full_node.server
        ...
        a_con: WSStaiConnection = full_node_server_a.get_connections()[0]
        b_con: WSStaiConnection = full_node_server_b.get_connections()[0]
