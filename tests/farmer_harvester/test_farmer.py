...
from stai.pools.pool_config import PoolWalletConfig
from stai.protocols import farmer_protocol, harvester_protocol
from stai.protocols.harvester_protocol import NewProofOfSpace, RespondSignatures
from stai.protocols.pool_protocol import PoolErrorCode
...
async def test_farmer_pool_response(
    ...
    peer = cast(WSStaiConnection, DummyHarvesterPeer(False))
    await farmer_api.new_proof_of_space(new_pos, peer)
