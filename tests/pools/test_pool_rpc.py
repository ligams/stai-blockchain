...
from stai.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH
...
from stai.simulator.block_tools import BlockTools, get_plot_dir
from stai.simulator.full_node_simulator import FullNodeSimulator
from stai.simulator.simulator_protocol import ReorgProtocol
...
from stai.wallet.derive_keys import find_authentication_sk, find_owner_sk
    ...
    async def test_absorb_self(
        ...
        async with manage_temporary_pool_plot(bt, status.p2_singleton_puzzle_hash) as pool_plot:
            ...
            tr: TransactionRecord = await client.send_transaction(
                1, uint64(100), encode_puzzle_hash(status.p2_singleton_puzzle_hash, "tstai"), DEFAULT_TX_CONFIG
            )
