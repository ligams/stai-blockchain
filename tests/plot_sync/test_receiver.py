...
from stai.plot_sync.receiver import Receiver, Sync
...
def assert_error_response(plot_sync: Receiver, error_code: ErrorCodes) -> None:
    ...
    # WSStaiConnection doesn't have last_sent_message its part of the WSStaiConnectionDummy class used for testing
