...
from stai.cmds.farm_funcs import summary
...
from stai.types.aliases import FarmerService, HarvesterService, SimulatorFullNodeService, WalletService
...
async def test_farm_summary_command(
    ...
    assert "Total stai farmed:" in lines[1]
