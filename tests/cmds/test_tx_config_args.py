...
from stai.cmds.cmds_util import CMDCoinSelectionConfigLoader, CMDTXConfigLoader, coin_selection_args, tx_config_args
from stai.util.config import create_default_stai_config, load_config
...
def test_tx_config_args() -> None:
    ...
    with runner.isolated_filesystem():
        create_default_stai_config(Path("."))
