...
from stai.types.blockchain_format.foliage import FoliageTransactionBlock
...
def test_stai_show(capsys: object, get_test_cli_clients: Tuple[TestRpcClients, Path]) -> None:
