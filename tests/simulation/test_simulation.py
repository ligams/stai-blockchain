...
from stai.daemon.server import WebSocketServer
...
from stai.simulator.simulator_protocol import FarmNewBlockProtocol, GetAllCoinsProtocol, ReorgProtocol
...
from stai.util.ws_message import create_payload
...
class TestSimulation:
    ...
    async def test_full_system(self, simulation, extra_node, self_hostname):
        ...
        server1: StaiServer = full_system.node_1._server
        ...
        server3: StaiServer = node3.full_node.server
        ...
        await time_out_assert(60, verify_daemon_connection, True, full_system.daemon, "stai_full_node")
