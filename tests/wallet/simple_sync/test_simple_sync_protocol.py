...
from stai.protocols.wallet_protocol import CoinStateUpdate, RespondToCoinUpdates, RespondToPhUpdates
...
class TestSimpleSyncProtocol:
    ...
    async def test_subscribe_for_ph(self, simulator_and_wallet, self_hostname):
        ...
        from stai.wallet.puzzles.singleton_top_layer import SINGLETON_LAUNCHER_HASH
