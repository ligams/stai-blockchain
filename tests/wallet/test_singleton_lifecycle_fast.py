...
from stai.wallet.util.debug_spend_bundle import debug_spend_bundle
...
POOL_MEMBER_MOD = load_clvm("pool_member_innerpuz.clsp", package_or_requirement="stai.pools.puzzles")
POOL_WAITINGROOM_MOD = load_clvm("pool_waitingroom_innerpuz.clsp", package_or_requirement="stai.pools.puzzles")
