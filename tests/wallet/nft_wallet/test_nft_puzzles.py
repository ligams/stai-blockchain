...
from stai.wallet.nft_wallet import uncurry_nft
from stai.wallet.nft_wallet.nft_puzzles import (
    construct_ownership_layer,
    create_full_puzzle,
    create_nft_layer_puzzle_with_curry_params,
    recurry_nft_puzzle,
)
from stai.wallet.outer_puzzles import match_puzzle
...
DID_MOD = load_clvm("did_innerpuz.clsp", package_or_requirement="stai.wallet.did_wallet.puzzles")
NFT_STATE_LAYER_MOD = load_clvm("nft_state_layer.clsp", package_or_requirement="stai.wallet.nft_wallet.puzzles")
NFT_OWNERSHIP_LAYER = load_clvm("nft_ownership_layer.clsp", package_or_requirement="stai.wallet.nft_wallet.puzzles")
NFT_TRANSFER_PROGRAM_DEFAULT = load_clvm(
    "nft_ownership_transfer_program_one_way_claim_with_royalties.clsp",
    package_or_requirement="stai.wallet.nft_wallet.puzzles",
)
...
NFT_METADATA_UPDATER_DEFAULT = load_clvm(
    "nft_metadata_updater_default.clsp", package_or_requirement="stai.wallet.nft_wallet.puzzles"
)
...
def test_nft_transfer_puzzle_hashes(seeded_random: random.Random) -> None:
    ...
    metadata = [("u", ["https://www.stai.net/img/branding/stai-logo.svg"]), ("h", 0xD4584AD463139FA8C0D9F68F4B59F185)]
