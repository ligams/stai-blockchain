...
from stai.wallet.cat_wallet.cat_info import LegacyCATInfo
...
from stai.wallet.derive_keys import _derive_path_unhardened, master_sk_to_wallet_sk_unhardened_intermediate
from stai.wallet.lineage_proof import LineageProof
from stai.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import puzzle_hash_for_pk
...
class TestCATWallet:
    ...
    async def test_cat_change_detection(
        ...
        addr = encode_puzzle_hash(cat_puzzle.get_tree_hash(), "tstai")
