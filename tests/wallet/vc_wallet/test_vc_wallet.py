...
from stai.types.blockchain_format.coin import coin_as_list
...
from stai.wallet.vc_wallet.cr_cat_drivers import ProofsChecker, construct_cr_layer
from stai.wallet.vc_wallet.cr_cat_wallet import CRCATWallet
from stai.wallet.vc_wallet.vc_store import VCProofs, VCRecord
...
async def test_vc_lifecycle(wallet_environments: WalletTestFramework) -> None:
    ...
    wallet_0 = wallet_environments.environments[0].stai_wallet
    wallet_1 = wallet_environments.environments[1].stai_wallet
    ...
    wallet_1_addr = encode_puzzle_hash(wallet_1_ph, "tstai")
