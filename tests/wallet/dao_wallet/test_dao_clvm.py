...
from stai.clvm.spend_sim import SimClient, SpendSim, sim_and_client
...
from stai.util.condition_tools import conditions_dict_for_solution
from stai.util.errors import Err
from stai.util.hash import std_hash
from stai.util.ints import uint32, uint64
from stai.wallet.cat_wallet.cat_utils import CAT_MOD
from stai.wallet.dao_wallet.dao_info import DAORules
from stai.wallet.dao_wallet.dao_utils import curry_singleton, get_p2_singleton_puzhash, get_treasury_puzzle
from stai.wallet.puzzles.load_clvm import load_clvm
from stai.wallet.singleton import create_singleton_puzzle_hash
...
def test_spend_p2_singleton() -> None:
    ...
    # Solution Values
    stai_parent_amt_list = [[b"x" * 32, 10], [b"y" * 32, 100]]
    cat_parent_amt_list = [
    ...
    # Solution
    spend_p2_sol = Program.to([stai_parent_amt_list, cat_parent_amt_list, treasury_inner_puzhash])
