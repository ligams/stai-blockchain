...
from stai.simulator.block_tools import BlockTools, create_block_tools_async
from stai.simulator.full_node_simulator import FullNodeSimulator
from stai.simulator.keyring import TempKeyring
from stai.simulator.setup_services import (
    setup_daemon,
    setup_farmer,
    setup_full_node,
    setup_harvester,
...
OldSimulatorsAndWallets = Tuple[List[FullNodeSimulator], List[Tuple[WalletNode, StaiServer]], BlockTools]
...
) -> AsyncIterator[Tuple[FullNodeAPI, FullNodeAPI, StaiServer, StaiServer, BlockTools]]:
    """
