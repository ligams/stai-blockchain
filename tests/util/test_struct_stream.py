...
from stai.util.ints import int8, int16, int32, int64, int512, uint8, uint16, uint32, uint64, uint128
from stai.util.struct_stream import StructStream, parse_metadata_from_name
